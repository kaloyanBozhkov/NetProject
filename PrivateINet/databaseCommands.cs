...
{
    /// <summary>
    /// This is a simple "database" of all the commands for the Hub to control a manufacturer device.
    /// For argument types: 1 is boolean, 2 is string 3 is integer
    /// </summary>
    /// 
    //When passing a string as argument the bits must be counted, remember it is ASCII encoding!!!!
    class databaseCommands
    {
        ...
        public Dictionary<int, command> commands = new Dictionary<int, command>() {
            ...
            {
                /// <summary>
                /// Argument expected to be a boolean for reboot (true) and an 16 bits for the number of milliseconds after which to perform reboot. Up to 65535ms = 65/66 seconds of wait time.
                /// </summary>
                100,
                new command()
                {
